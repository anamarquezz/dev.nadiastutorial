@extends('layouts.app')
@section('title',"Nadia's Garden Restaurant - Creating memories, one experience at a time")

@section('content')
  <h4 class="intro">Creating memories, one experience at a time</h4>
<p>
    Nadia’s Garden Restaurant isn’t just about dining. We’re about creating memorable experiences that our
    guest will cherish!
